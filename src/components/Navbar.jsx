...
import Alogo from "../assets/bgremovelogo.png";
...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-1 left-0 w-full flex items-center justify-between px-6 py-4 z-50 transition-transform duration-300 ${visable ? "translate-y-0" : "-translate-y-full"}`}
      >
        <div className='flex items-center space-x-4'>
          <img src={Alogo} alt="logo" className='w-10 h-10' />
